    ...
    <div className="min-h-screen bg-[#FFF5E8] flex flex-col justify-between">
      <div className="flex-grow flex flex-col items-center py-16">
        ...
        <form
          ...
          className="flex flex-col gap-6 w-full max-w-md p-8 rounded-xl bg-white bg-opacity-90 border-2 border-solid border-black border-opacity-10 shadow-md"
        >
          <div>
          ...
          {/* POPUP NOTIFICATION - DIBAWAH FORM */}
          {showPopup && (
            <div className="mt-6 bg-green-500 text-white px-6 py-4 rounded-xl shadow-lg text-center text-lg font-semibold transition-all duration-300">
